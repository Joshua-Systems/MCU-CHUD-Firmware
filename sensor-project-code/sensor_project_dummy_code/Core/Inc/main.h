...
#define GNSS_LED_Pin GPIO_PIN_3
#define GNSS_LED_GPIO_Port GPIOE
#define CAN_LED_Pin GPIO_PIN_4
#define CAN_LED_GPIO_Port GPIOE
#define BMP_INT_Pin GPIO_PIN_1
#define BMP_INT_GPIO_Port GPIOC
#define ACCL_INT1_Pin GPIO_PIN_2
#define ACCL_INT1_GPIO_Port GPIOC
#define ACCL_INT2_Pin GPIO_PIN_3
#define ACCL_INT2_GPIO_Port GPIOC
#define ACCL_CS_Pin GPIO_PIN_2
